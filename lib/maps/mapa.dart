import 'package:apptour/maps/pagina.dart';
...
class Mapa extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => MapaState(this.lugar);

}

class MapaState extends State<Mapa> {
  Lugar lugar;
  MapaState(this.lugar);
 
  
  static final CameraPosition _posicionInicial = const CameraPosition(
    target: LatLng(-0.7018186302289788, -80.10555384429551),
    zoom: 11.0,
  );
